...
namespace TruongAnhTuanWPF.ViewModel
{
    ...
    {
        private readonly ManageBookingService _manageBookingService;
        ...
        {
            // Sử dụng singleton service từ App
            _manageBookingService = App._manageBookingServiceSingleton;
            var reservations = _manageBookingService.GetReservationsByCustomerId(customer.CustomerId);
