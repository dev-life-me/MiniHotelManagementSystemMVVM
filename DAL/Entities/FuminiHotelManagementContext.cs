...
public partial class FuminiHotelManagementContext : DbContext
{
    ...
    public virtual DbSet<AdminAcount> AdminAcounts { get; set; }
    ...
    {
        modelBuilder.Entity<AdminAcount>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__AdminAco__719FE4E836056FCD");

            entity.ToTable("AdminAcount");
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A1474097CBF66B").IsUnique();
